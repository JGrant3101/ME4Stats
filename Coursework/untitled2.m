...
COfromdayresiduallol = COpredfromday - CO;

[HCOfromdayresiduallol, pValueCOfromdayresiduallol, WCOfromdayresiduallol] = swtest(COfromdayresiduallol, 0.05);

% Printing values
disp(['The probability suggested by the Shapiro-Wilks test of the residuals of CO from Day coming from a normal distribution is: ', num2str(pValueCOfromdayresiduallol)])

if ~HCOfromdayresiduallol
